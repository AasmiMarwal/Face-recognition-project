...
dir_name = r'C:\Users\AA&AA\Documents\Python Scripts\dataset\dataset\faces'
y = []
X = []
target_names = []
person_id = 0
...
for person_name in os.listdir(dir_name):
    dir_path = os.path.join(dir_name, person_name)  # Correct path formation
    class_names.append(person_name)
    for image_name in os.listdir(dir_path):
        # formulate the image path
        image_path = os.path.join(dir_path, image_name)  # Correct path formation
